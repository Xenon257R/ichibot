module.exports = {
    specificHelp : function(arg) {
        switch (arg) {
            ...
            case 'add':
                return "```md\n" +
                    "-a|add [TYPE] [TRACKNAME] [AUDIOURL] (tag)  ---  Add audio tracks to playlist.\n" +
                    "> Example: -add hanchan \"New Track\" https://website/urltonewtrack/dir/file.mp3 Tag1 Tag2\n" +
                    "* If any parameters need a space ( ), enclose the parameter in quotes \"like so\".\n" +
                    "* Valid [TYPE] parameters are as follows:\n" +
                    ...
                    "* You may optionally apply tags immediately to your new track by specifying them at the end of the command.```";
            case 'd':
            case 'delete':
                return "```md\n" +
            ...
            case 'list':
                return "```md\n" +
                    "-l|list (verbose)  ---  List your uploaded tracks.\n" +
                    "> Example: -list\n\n" +
                    "* You can only request your own list.\n" +
                    "* If \"verbose\" is specified, the list will also show the track tags.```"
            case 't':
            case 'tag':
                return "```md\n" +
                    "-t|tag [param] [arguments]  ---  Manage tags.\n" +
                    "* The param-argument combinations are as follows:\n" +
                    "*   [c|create / r|remove] [TAGNAME]\n" +
                    ">   Example: -tag create BBEG\n" +
                    "  *  Each user is permitted 5 tags at maximum. New ones cannot be created until 1 or more is deleted for space.\n" +
                    "  *  Tag names must be unique (among your alotted 5), consist only of letters & numbers and be 10 characters or less. No spaces are permitted.\n" +
                    "*   [a|attach / d|detatch] [TRACKNAME] [TAGNAME]\n" +
                    ">   Example: -tag a \"Bamboo\" Generic\n" +
                    "  *  A track can have multiple tags.\n" +
                    "  *  The base location of the track (e.g. Riichi, Ambient, Jukebox) is not factored in for tagging.\n" +
                    "*   [m|mode] (0 / hanchan / ambient / 1 / riichi / battle)\n" +
                    ">   Example: -mode ambient\n" +
                    "  *  Repeat mode tags will be highlighted Green, whereas continuous mode tags will be highlighted Blue.\n" +
                    "  *  Not specifying a new mode change will instead toggle the existing behavior.```"
            case 'x':
            case 'export':
                return "```md\n" +
