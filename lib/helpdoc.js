    ...
    specificHelp : function(arg) {
        switch (arg) {
            ...
            case 'faq':
                ...
                "You can still \"validate\" tracks by trying to play them in the Jukebox and see if playback works there.\n" +
                ...
                "> IchiBot suddenly stopped working. What should I do?\n" +
                "IchiBot should reboot itself in a few minutes if it ever crashes. IchiBot also does a weekly reset at every Tuesday at midnight (UTC) to free memory, during which all its processes will get interrupted. Just wait for IchiBot to disconnect or kick it from the channel, then mention IchiBot back in.```"
            case 'mp3':
                return "```md\n" +
