		...
		collector.on('collect', async i => {
			...
			switch (i.customId) {
				...
				case 'jukebox':
					...
					jukeboxPage = 0;
					buttons.jukebox[2].components[0].setDisabled(true);
				...
				case 'next':
					...
					if (jukeboxPage <= 0) buttons.jukebox[2].components[0].setDisabled(true);
					else buttons.jukebox[2].components[0].setDisabled(false);
					if (jukeboxPage >= (Math.ceil(jukeboxAlbum.length / 10) - 1)) buttons.jukebox[2].components[4].setDisabled(true);
